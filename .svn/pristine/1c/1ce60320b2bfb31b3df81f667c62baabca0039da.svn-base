...
namespace SAMLitigation.Controllers
{
    public class SAM_Litigation_PartyController : Controller
    {
        ...
        private readonly LoanProjectService _loanProjectService;
        public SAM_Litigation_PartyController(ILogger<SAM_Litigation_PartyController> logger, LitigationPartyService partyService, LoanProjectService loanProjectService) 
        {
            _logger = logger;
